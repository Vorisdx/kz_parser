...
#         value=True,
#         help="Снимите галочку, если хотите видеть реальное окно браузера (для отладки).",
#     )
#     btn_close = st.checkbox("Автоматически закрывать браузер после запроса", value=True)
